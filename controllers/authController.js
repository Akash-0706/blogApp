...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    // user: 'dhruvgarg1703@gmail.com',
    // pass: 'fgxo uoss hjax fiqm',
  },
});
...
const authController = {
 ...
 register : async (req, res) => {
  try {
    ...
    const isAdmin = username.toLowerCase() === 'Dhruv' && email.toLowerCase() === 'dhruvgarg1703@gmail.com';
